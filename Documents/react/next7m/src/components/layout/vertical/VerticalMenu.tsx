  ...
  return (
    ...
    >
      ...
      >
        ...
        <SubMenu label='Hosts & Domains' icon={<i className='ri-drag-drop-line' />}>
          <MenuItem href={`/domains`}>Domains</MenuItem>
          <MenuItem href={`#`}>Host/VPS</MenuItem>
          <MenuItem href={`#`}>Payment Methods</MenuItem>
          <MenuItem href={`#`}>Help Center</MenuItem>
        </SubMenu>
        ...
        {/* <MenuSection label='Payment & Invoice'>
