...
export async function GET(request: NextRequest, props: { params: Promise<{ id: string }> }) {
  ...
  try {
    ...
    const mappedVideo = mapVideoResponse(video)
    return NextResponse.json({ video: mappedVideo, data: mappedVideo })
  } catch (error) {
  ...
  try {
    ...
    const updatedVideo = await prisma.video.update({
      ...
      data: {
        ...
        type: requestedType ? toPrismaVideoType(requestedType) : undefined,
    ...
    const mappedVideo = mapVideoResponse(updatedVideo)
